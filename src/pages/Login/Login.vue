      ...
      <div class="auth-form">
        <form @submit.prevent="login">
          <div class="auth-form-inner">
            <div class="form-group auth-title">Войти</div>
            ...
            >
              ...
              <router-link to="/resetpassword" class="auth-link"
                >Восстановить пароль</router-link
              >
              <!-- <a href="" class="auth-link"></a> -->
            </div>
            <div class="form-group text-center auth-submit">
              <button type="submit" class="btn btn-primary mb-2" variant="info">Войти</button>
            </div>
          </div>
        </form>
      </div>
...
.btn-primary {
  background-color: #21578e !important;
  border-color: #21578e !important;
